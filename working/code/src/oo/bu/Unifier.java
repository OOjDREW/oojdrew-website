...
public class Unifier {
    ...
    /**
     *
     * @param fact DefiniteClause
     * @param rule DefiniteClause
     */
     
    //This is used to create a unifier to compare 2 terms
     public Unifier(){
     	vars = new Term[2][];
     ...
     //the unifier makes new terms so I need to figure this out
     //how to carry over DATA
    public Unifier(DefiniteClause fact, DefiniteClause rule) {
        super();
        
        //test here for fact / rule
     ...
     * @return boolean
     */
     //was private changed to public so I can compare 2 terms.
