...
public class DefiniteClause {
     ...
     * otherwise RuleML (0.88 + rests) is used.
     *
    ...
    /**
     * Builds and returns a RuleML (0.88 + rests) string representation of the
    ...
    /**
     * Builds and returns a RuleML (0.88 + rests) representation of the object
     ...
     */
     ...
     //MAY NEED TO MAKE A CHANGE HERE
     //POSSIBLE CHANGE HERE
     
    public Element toRuleML() {
		
	//	for(int i = 0; i < atoms.length; i++){
	//	String s = atoms[0].getSymbolString();
	...
	//	}//getting the relation
        ...
        if (atoms.length == 1) {
            ...
            el = atoms[0].toRuleML(variableNames, true);
        } else {
            ...
            el.appendChild(atoms[0].toRuleML(variableNames, true));
